  ...
  return (
    ...
    <div className='BodyPro2'>
            <div className='HeaderPro2'>
                <img src={require('../../Images/bdsubbanner.jpg')} />
