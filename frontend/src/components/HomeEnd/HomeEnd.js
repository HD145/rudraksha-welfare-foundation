...
function HomeEnd() {
    return (
        <div className='container-fluid Homeend '>
           <div className='Endcontainer1 mx-3'>
           ...
           {/* <div className="container-fluid  support">
                <div className='row '>
                    <div className='col col-lg-3 col1'>
                     <img src={require('../../Images/Support1b.png')
                } className="img1s" ></img>
    
                        <h3 className="multicolortext"> Projects</h3>
                        <p  className="multicolortext">
                        There are many variations of passage of Lorem Ipsum available, but the majority have suffered ...
                        </p>
                          
                    </div>
                    <div className='col col-lg-3 col2'>
                    <img src={require('../../Images/Support2b.png')
                } className="img2s" ></img>
                     <h3 className="multicolortext"> Products</h3>
                    ...
                    <div className='col col-lg-3 col3'>
                    <img src={require('../../Images/responsibility.png')
                } className="img3s" ></img>
                      <h3 className="multicolortext"> Values</h3>
                        <p className="multicolortext">
                        There are many variations of passage of Lorem Ipsum available, but the majority have suffered ...
                        </p>
